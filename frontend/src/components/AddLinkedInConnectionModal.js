...
const AddLinkedInConnectionModal = ({ open, onClose, onConnect }) => {
      ...
      <DialogContent sx={{ py: 4 }}>
        <Box sx={{ textAlign: 'center', mb: 3 }}>
          ...
          <Typography variant="body1" color="text.secondary" sx={{ mb: 3 }}>
            Connect your LinkedIn account to automatically publish your AI-generated articles.
          </Typography>
        ...
        <Box sx={{ mt: 3, p: 2, bgcolor: 'background.default', borderRadius: 2 }}>
          <Typography variant="caption" color="text.secondary">
            By connecting, you'll be redirected to LinkedIn to authorize access. We'll use this connection to publish your content.
          </Typography>
        </Box>
      </DialogContent>
    </Dialog>
...
export default AddLinkedInConnectionModal;
